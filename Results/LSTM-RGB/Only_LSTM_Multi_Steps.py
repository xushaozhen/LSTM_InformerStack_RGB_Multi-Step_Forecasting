...
# processor1 = Data_deletion('original_2021_9_10_images_path.csv', n_hours,images_features,"2021_9_10_images_path.csv")
...
class Mytransformer(nn.Module):
    def __init__(self,n_hours,n_features):
        ...
        self.lstm = nn.LSTM(input_size=n_features,hidden_size=hidden_size,num_layers=1,
                          batch_first=True,)
        self.positionEncoding = PositionEncoding(4,0.2,max_len=100)
        self.transformer = nn.Transformer(d_model=n_features,nhead=n_features,num_encoder_layers=2,num_decoder_layers=2,dim_feedforward=64,dropout=0.3,activation='relu',)
...
extra_data_mean=[np.mean(results_list[0]),all_samples_nrmse_mean,
