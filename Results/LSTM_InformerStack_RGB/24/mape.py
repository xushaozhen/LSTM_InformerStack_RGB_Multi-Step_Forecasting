...
class EvaluationMetrics:
    ...
    def calculate_multi_step_all_samples_rmse(self,predictions, targets,persistence_nrmse):
        ...
        for i in range(num_steps):
            ...
            smape_step=self.FS_nRMSE(target_step,prediction_step,persistence_nrmse)
...
persistence_nrmse_list=[0.474,0.591,0.652,0.700]
if pred_len==1:
    persistence_nrmse=persistence_nrmse_list[0]
elif pred_len==6:
    persistence_nrmse=persistence_nrmse_list[1]
elif pred_len==12:
    persistence_nrmse=persistence_nrmse_list[2]
else :
    persistence_nrmse=persistence_nrmse_list[3]
targets=trues
predictions=preds
...
[rmse_values_list,nrmse_values_list,mape_values_list,
    smape_values_list,R2_values_list,all_samples_nrmse_mean,
    all_samples_mape_mean,all_samples_smape_mean,
    all_samples_R2_mean] = eval_metrics.calculate_multi_step_all_samples_rmse(predictions, targets,persistence_nrmse)
