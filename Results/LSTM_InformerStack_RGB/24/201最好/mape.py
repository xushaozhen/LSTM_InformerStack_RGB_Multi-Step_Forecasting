...
df = pd.read_csv('Final_Pred_trues_Statistics_Results1.csv',header=0,index_col=0)
#print()
...
def Save_data_to_a_specified_file(results_list,extra_data_mean):
    ...
    write_metrics_to_csv("./Final_Evaluation_Index_Statistics_Results_nmae.csv", results_list[0],results_list[1],results_list[2],results_list[3],results_list[4], extra_data_mean)
