# -*- coding: utf-8 -*-
"""
Created on Tue Nov 14 18:44:00 2023
...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 14 18:39:11 2023
...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 14 18:35:25 2023
...
class EvaluationMetrics:
    ...
    def nmse(self, actual, pred):
        actual, pred = np.array(actual), np.array(pred)
        actual_mean=np.mean(actual) 
        mse2 =((self.nrmse(actual, pred)*actual_mean)**2)
        
        print("actual_mean:",actual_mean)
        return mse2/actual_mean
    ...
    def calculate_multi_step_all_samples_rmse(self,predictions, targets,persistence_nrmse_list):
        ...
        for i in range(num_steps):
            ...
            persistence_nrmse=persistence_nrmse_list[i]
            rmse_step = self.calculate_rmse(prediction_step, target_step)
            nrmse_step=self.nrmse(target_step,prediction_step)
            mape_step=self.smape(target_step,prediction_step)
            print("persistence_nrmse:",persistence_nrmse)
            print("mape_step:",mape_step)
            smape_step=1-(nrmse_step/persistence_nrmse)
            ...
            print("mape_values_list:",mape_values_list)
...
df = pd.read_csv('Final_Pred_trues_Statistics_Results.csv',header=0,index_col=0)
#print()
...
persistence_nrmse_list_case1=[0.474]
persistence_nrmse_list_case2=[0.473419	,0.5267331	,0.5836348	,0.64151144,	
                              0.64218867,0.6756182]
persistence_nrmse_list_case3=[0.47271526,	0.52598363	,0.5828862,	
                              0.64066863	,0.6412527	,0.6745915,	0.6832834,	
                              0.6958863,	0.71820664,	0.73017216	,0.72876364	,
                              0.7337809]


persistence_nrmse_list_case4=[
0.47199136, 0.5250613, 0.58174485, 0.6392982, 0.6397979, 0.67295295 ,
0.6815421, 0.6941288, 0.7163314, 0.72818303, 0.72670066 ,0.7316049, 0.7389107,
 0.7508669 ,0.7595579, 0.753365, 0.73805195, 0.732947, 0.7371686 ,0.7284636,
 0.7508309, 0.7553345 ,0.7699714, 0.776042]
print("persistence_nrmse_list_len:",len(persistence_nrmse_list_case4))

if pred_len==1:
    persistence_nrmse_list=persistence_nrmse_list_case1
elif pred_len==6:
    persistence_nrmse_list=persistence_nrmse_list_case2
elif pred_len==12:
    persistence_nrmse_list=persistence_nrmse_list_case3
else :
    persistence_nrmse_list=persistence_nrmse_list_case4
targets=trues
predictions=preds
...
[rmse_values_list,nrmse_values_list,mape_values_list,
    smape_values_list,R2_values_list,all_samples_nrmse_mean,
    all_samples_mape_mean,all_samples_smape_mean,
    all_samples_R2_mean] = eval_metrics.calculate_multi_step_all_samples_rmse(predictions, targets,persistence_nrmse_list)
...
def Save_data_to_a_specified_file(results_list,extra_data_mean):
    ...
    write_metrics_to_csv("./Final_Evaluation_Index_Statistics_Results_fs.csv", results_list[0],results_list[1],results_list[2],results_list[3],results_list[4], extra_data_mean)
