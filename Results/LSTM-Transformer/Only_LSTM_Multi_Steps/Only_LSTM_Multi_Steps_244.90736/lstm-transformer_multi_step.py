...
class Mytransformer(nn.Module):
    def __init__(self,n_hours,n_features):
        ...
        self.transformer = nn.Transformer(d_model=hidden_size,nhead=n_features,num_encoder_layers=2,num_decoder_layers=2,dim_feedforward=64,dropout=0.3,activation='relu',)
