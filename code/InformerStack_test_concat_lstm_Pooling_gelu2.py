# -*- coding: utf-8 -*-
"""
Created on Sat Aug  5 15:44:39 2023
...
# -*- coding: utf-8 -*-
"""
Created on Sat Aug  5 15:33:58 2023
...
from models.model_lstm_concat_Pooling_gelu2 import Informer, InformerStack
...
seed = 42  
Save_file_root_path="InformerStack_Train_test_multi_step_12"
...
model =InformerStack(enc_in,dec_in, c_out, seq_len, label_len, out_len, 
            factor=5, d_model=d_model, n_heads=8, e_layers=[3,2,1], d_layers=d_layers, d_ff=d_ff, 
            dropout=0.0, attn='prob', embed='fixed', freq='h', activation='gelu',
            output_attention = False, distil=True, mix=True,device=device)
...
class Dataset_Custom(Dataset):
    def __init__(self, root_path, flag='train', size=None, 
                 features='MS', data_path=data_path, 
                 target='csi', scale=True, inverse=False, timeenc=0, freq='h', cols=None,Dataset_partition_ratio=[0.7,0.2]):
