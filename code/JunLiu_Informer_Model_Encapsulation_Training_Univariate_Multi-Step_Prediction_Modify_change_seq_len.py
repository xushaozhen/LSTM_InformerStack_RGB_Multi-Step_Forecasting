...
import shutil
import random
from models.model3_add_lstm import Informer, InformerStack
...
seed = 42  
Save_file_root_path="Univariate_Multi-Step_Prediction"
...
model =Informer(enc_in=4, dec_in=4, c_out=1, seq_len=seq_len, label_len=label_len, out_len=out_len, 
            ...
            dropout=dropout, attn='prob', embed='timeF', freq='h', activation='gelu', 
